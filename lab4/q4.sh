...
python3 lab4.py --epoch 5 --gpu --gpu_count 1 --batch_size 128 --workers 16 --disable_batch_norm

python3 lab4.py --epoch 5 --gpu --gpu_count 4 --batch_size 512 --workers 16 --disable_batch_norm
